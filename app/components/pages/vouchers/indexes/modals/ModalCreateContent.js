...
export const ModalCreateContent = ({ formData, props, stateKey }) => {
  ...
  formData.quota =
    formData.quota == 0 || formData.quota == "" ? "" : formData.quota;
      ...
      {tourData && (
        <CmsDivRow>
          <CmsSelectMultiple
            {...inputTourCode}
            onChange={(e) => {
              handler.handleFormUpdate("tourCode", e);
            }}
            listData={tourData}
            type={"tour"}
          />
      ...
      {regionData && (
        <CmsDivRow>
          <CmsSelectMultiple
            {...inputRegionName}
            onChange={(e) => {
              handler.handleFormUpdate("regionName", e);
            }}
            listData={regionData}
            type={"region"}
          />
      ...
      {airlineData && (
        <CmsDivRow>
          <CmsSelectMultiple
            {...inputAirlineCode}
            onChange={(e) => {
              handler.handleFormUpdate("airlineCode", e);
            }}
