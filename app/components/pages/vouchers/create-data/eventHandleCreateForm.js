...
const onChangeInputArea = (data, index, dataFilter, onChangeFilter) => {
  const value = data;
  const updateDataFilter = [...dataFilter];
  updateDataFilter[index].value = value;
  onChangeFilter(updateDataFilter);
...
const onChangeSwitch = (data, index, dataFilter, onChangeFilter) => {
  const value = data;
  const updateDataFilter = [...dataFilter];
  updateDataFilter[index].value = value;
  onChangeFilter(updateDataFilter);
...
export const eventHandleCreate = async (
  ...
  switch (type) {
    ...
    case "Switch":
      onChangeSwitch(data, index, dataCreate, onChangeCreate);
      break;
