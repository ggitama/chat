...
import { 
  ...
  useEffectMains, 
  useMainHooks
} from "@/components/pages/bookings/sales/flight"
import { CardSummary, sharedTabModel } from "@/components/pages/bookings/sales/indexes"
...
const ScreenPage = (props)=>{
  const pageTitle = "Booking Management Sales"
      ...
      <CmsTableRow key={"prepend"}>
        <Tabs 
          ...
          onChange={(tabKey)=>{
            ...
            router.push(`/bookings/sales/${tabKey}`)
          }}
        ></Tabs>
