...
} from "@/components/pages/push-notification/indexes"
import DataTableHelper from "@/util/cms/datatable.helper"
import { CmsModal } from "@/components/Cms/Modals"
import { useReducer, useEffect } from "react"
import { ModalDeleteContent } from "@/components/pages/push-notification/indexes/modals/ModalDeleteContent"
import { useModalDeleteHooks } from "@/components/pages/push-notification/indexes/hooks/modal-delete.hooks"
    ...
    return (
        <>
            ...
            <CmsModal
                ...
                onClickConfirm={(activeFormData, footerHandler) => {
                    if (footerHandler?.handleModalCreateSubmit) {
            ...
            <CmsModal
                ...
                onClickConfirm={(activeFormData,footerHandler)=>{
                    footerHandler.handleModalDeleteSubmit(state.IS_SHOW_MODAL_DELETE.dataRow, () => {
                        footerHandler.handleClearFormData();
                      });
                }}
                >
